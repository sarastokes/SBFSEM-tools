classdef GraphApp < handle
    ...
    methods (Access = private)
        function createUi(obj)
            ...
            % Create the figure and resize
            obj.figureHandle = figure(...
                'Name', 'GraphUI',...
                'Color', 'w',...
                'NumberTitle', 'off',...
                'DefaultUicontrolBackgroundColor', obj.BACKGROUND_COLOR,...
            ...
            % Display aesthetics controls
            uix.Empty('Parent', uiLayout,...
                'BackgroundColor', obj.BACKGROUND_COLOR);
            [~, p] = LayoutManager.verticalBoxWithLabel(uiLayout, 'Marker Size:',...
                'Style', 'popup',...
                'String', {'Minimal', 'Medium', 'Large'},...
                'Tag', 'NodeSize',...
                'TooltipString', 'Change annotation marker size',...
                'Callback', @obj.onSelectedMarkerType);
            set(p, 'BackgroundColor', obj.BACKGROUND_COLOR);
            [~, p] = LayoutManager.verticalBoxWithLabel(uiLayout, 'Colormap:',...
                'Style', 'popup',...
        ...
        function createHelpTab(obj, parentHandle)
            % CREATEHELPTAB  Set up the help tab
