    ...
    methods (Access = private)
        ...
        function createUI_plots(obj)
            ...
            obj.handles.cb.addSkeleton = uicontrol('Parent', obj.handles.layouts.skel,...
                ...
                'Visible', 'off');
            obj.handles.pb.skelBack = uicontrol('Parent', obj.handles.layouts.skel,...
                'Style', 'push', 'String', '<-', 'Visible', 'off');
            obj.handles.tx.skelBins = uicontrol('Parent', obj.handles.layouts.skel,...
                'Style', 'text', 'Visible', 'off');
            obj.handles.pb.skelFwd = uicontrol('Parent', obj.handles.layouts.skel,...
                'Style', 'push', 'String', '->', 'Visible', 'off');
            set([obj.handles.pb.skelFwd, obj.handles.pb.skelBack],...
                'Callback', @obj.deltaSkeleton);
            set(obj.handles.layouts.skel, 'Widths', [-2 -0.5 -0.5 -0.5],...
                'BackgroundColor', 'w');
